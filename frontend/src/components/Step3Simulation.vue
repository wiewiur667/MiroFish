...
const fetchRunStatus = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Check via twitter_completed and reddit_completed flags
...
const checkPlatformsCompleted = (data) => {
  ...
  // If at least one platform done, check if all enabled are done
...
const fetchRunStatusDetail = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Do not auto-scroll, let user browse timeline freely
